...
<body>
    ...
    <div class="print-container">
        ...
        <!-- Header dengan gradient biru dan logo -->
        <div class="header-gradient bg-gradient-to-r from-[#1e4b8c] to-[#2563eb] text-white px-6 py-5 -mt-8 -mx-8 mb-6 text-center relative" style="margin-top: -30px; margin-left: -40px; margin-right: -40px; padding-top: 35px; padding-bottom: 20px;">
            <!-- Logo di pojok kiri -->
            <div class="absolute left-8 top-1/2 transform -translate-y-1/2">
                <img src="{{ asset('images/logo.png') }}" alt="Logo UPT Komputer" class="w-16 h-16 object-contain bg-white/10 p-1 rounded-full" onerror="this.style.display='none'">
            </div>

            <h1 class="text-xl font-bold uppercase tracking-wide">UNIT PELAKSANA TEKNIS (UPT) KOMPUTER</h1>
            <h2 class="text-lg font-normal">Universitas PGRI Madiun</h2>
        </div>
        ...
        <table class="w-full text-sm">
            ...
            <tr class="align-top">
                ...
                <td class="py-2 pl-2">: <td>: {{ $prakerin->tanggal_mulai_prakerin ?? '-' }}</td></td>
            </tr>
            <tr class="align-top">
                <td class="font-bold w-48 py-2">Tanggal Akhir Prakerin</td>
                <td class="py-2 pl-2">: <td>: {{ $prakerin->tanggal_akhir_prakerin ?? '-' }}</td></td>
            </tr>
            <tr class="align-top">
